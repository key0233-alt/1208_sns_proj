-- ============================================
-- Migration: Create SNS Schema
-- Created: 2025-12-08
-- Description: Instagram Clone SNS Database Schema
-- ============================================
-- This migration creates the complete database schema for the SNS application:
-- 1. Users table (Clerk integration)
-- 2. Posts, Likes, Comments, Follows tables
-- 3. Views (post_stats, user_stats)
-- 4. Triggers (handle_updated_at)
-- ============================================
-- Note: RLS is disabled for development (per project rules)
-- ============================================
